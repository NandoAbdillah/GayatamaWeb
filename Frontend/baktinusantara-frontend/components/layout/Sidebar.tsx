    ...
    switch (user?.role) {
      case "mahasiswa":
        return [
          ...
          {
            href: "/mahasiswa/progress",
            label: "Logbook Harian",
            icon: BookOpen,
            badge: "Aktif",
          },
          {
            href: "/mahasiswa/lokasi",
          ...
          {
            href: "/mahasiswa/portofolio",
            label: "Luaran & Portofolio",
            icon: Award,
          },
          {
      ...
      case "perangkat_desa":
        return [
          ...
          {
            href: "/perangkat-desa/pos-kebutuhan",
            label: "Pos Kebutuhan",
            icon: ClipboardList,
          },
          {
            href: "/perangkat-desa/proposal",
            label: "Proposal Masuk",
            icon: FileCheck2,
          },
          {
            href: "/perangkat-desa/surat-tugas",
            label: "Surat Tugas Desa",
            icon: FileSignature,
          },
          {
            href: "/perangkat-desa/luaran",
            label: "Verifikasi Luaran",
            icon: Award,
          },
          {
          ...
          {
            href: "/perangkat-desa/progress",
            label: "Monitoring Mahasiswa",
            icon: Activity,
          },
          {
            href: "/perangkat-desa/bast",
            label: "Penilaian & BAST",
            icon: Award,
          },
          {
            href: "/perangkat-desa/riwayat",
            label: "Riwayat KKN Desa",
            icon: History,
          },
        ];
      case "dosen":
      ...
      case "admin":
        return [
          ...
          {
            href: "/admin/pos-kebutuhan",
            label: "Kebutuhan Desa",
            icon: ClipboardList,
          },
          {
            ...
            <div className="flex items-center gap-3">
              ...
              <div
                className={cn(
                  ...
                  collapsed
                    ? "max-w-0 opacity-0 flex-none delay-0"
                    : "max-w-[160px] opacity-100 flex-1 min-w-0 delay-75",
                )}
              >
                  ...
                  >
                    ...
                    <span
                      className={cn(
                        ...
                        collapsed
                          ? "max-w-0 opacity-0"
                          : "max-w-[140px] opacity-100 delay-75",
                      )}
                    >
                      {item.label}
                    </span>
                  ...
                  {item.badge && (
                    <span
                      className={cn(
                        ...
                        collapsed
                          ? "max-w-0 opacity-0 px-0 ml-0"
                          : "max-w-[80px] opacity-100 ml-2 delay-75",
                        isActive
