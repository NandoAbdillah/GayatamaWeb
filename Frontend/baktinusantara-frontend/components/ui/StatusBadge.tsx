...
export const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  > = {
    ...
    draft: {
      bg: 'bg-slate-100 dark:bg-navy-900 border-slate-200 dark:border-navy-700',
    ...
    revision: {
      bg: 'bg-orange-50 dark:bg-orange-950/60 border-orange-200/80 dark:border-orange-800/80',
  ...
  return (
    <span
      className={cn(
        'inline-flex items-center rounded-full border shadow-sm select-none whitespace-nowrap',
        current.bg,
        current.text,
        sizeClasses[size],
        className
