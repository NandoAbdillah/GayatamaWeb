  ...
  return (
    <DashboardLayout title="Validasi Kelayakan Proposal Binaan">
      <div className="space-y-6 font-jakarta">
        <div>
          <h1 className="text-2xl font-extrabold text-navy-950 font-epilogue">Validasi Kelayakan Proposal Program KKN</h1>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-navy-950/60 backdrop-blur-sm animate-in fade-in">
            <div className="bg-white rounded-3xl max-w-md w-full p-6 sm:p-8 shadow-2xl border border-slate-200 space-y-5">
              ...
              <div className="text-center space-y-2">
                <h3 className="text-lg font-extrabold text-navy-950 font-epilogue">Setujui Proposal Ini?</h3>
