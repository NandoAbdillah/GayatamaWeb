    ...
    public function run(): void
    {
        ...
        $pos1 = PosKebutuhan::firstOrCreate(
            ...
            [
                ...
                'kategori' => 'umkm',
                'target_luaran' => [
                    'Identitas visual & 15 desain label kemasan modern UMKM',
                    'Katalog produk online di marketplace digital',
                    'Buku panduan pembukuan keuangan kas UMKM sederhana',
                ],
                'sdg_codes' => [8, 9],
                'kuota_kelompok' => 1,
        ...
        $pos2 = PosKebutuhan::firstOrCreate(
            ...
            [
                ...
                'kategori' => 'lingkungan',
                'target_luaran' => [
                    'Prototipe instalasi reaktor biogas ternak warga',
                    'Modul panduan pemilahan sampah organik & anorganik',
                    'Peta titik pengelolaan sampah dusun desa',
                ],
                'sdg_codes' => [13, 15],
                'kuota_kelompok' => 1,
        ...
        $pos3 = PosKebutuhan::firstOrCreate(
            ...
            [
                ...
                'kategori' => 'kesehatan',
                'target_luaran' => [
                    'Aplikasi/Spreadsheet pencatatan digital data balita posyandu',
                    'Buku saku menu gizi seimbang cegah stunting ibu hamil',
                    'Poster infografis edukasi kesehatan posyandu',
                ],
                'sdg_codes' => [3],
                'kuota_kelompok' => 2,
        ...
        $pos4 = PosKebutuhan::firstOrCreate(
            ...
            [
                ...
                'kategori' => 'pendidikan',
                'target_luaran' => [
                    'Modul pembelajaran interaktif bahasa Inggris dasar',
                    'Kegiatan literasi komputer dan pengenalan internet sehat',
                    'Bank soal latihan belajar siswa SD',
                ],
                'sdg_codes' => [4],
                'kuota_kelompok' => 1,
        ...
        $pos5 = PosKebutuhan::firstOrCreate(
            ...
            [
                ...
                'kategori' => 'fasilitas',
                'target_luaran' => [
                    'Gambar 3D masterplan ruang terbuka hijau desa',
                    'Rencana Anggaran Biaya (RAB) pembangunan fasilitas',
                    'Laporan analisis kelayakan lokasi taman desa',
                ],
                'sdg_codes' => [9, 11],
                'kuota_kelompok' => 1,
